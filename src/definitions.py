...
parsing_table = {
    ...
    "<initial_value>": {"(": ["(","<initial_value>",")"],"chr_lit": ["chr_lit", "<expression>"], "int_lit": ["int_lit", "<expression>"], "dec_lit": ["dec_lit", "<expression>"],"id":["id","<id_tail>","<expression>"]},
    "<condition>": {},
...
def add_all_set():
    ...
    add_set(["def","key","rsm", "key", "}"], "<brk>", ["null"])
